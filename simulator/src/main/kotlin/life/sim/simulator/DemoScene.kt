...
data class DemoScene(
    ...
    override fun init() {
        ...
        objectManager.add(
            SimWrapper(Vector2(MOLECULE_X, NUCLEOTIDE_Y), 0f,nucleotide),
            SimWrapper(Vector2(MOLECULE_X, SEQUENCE_Y), 0f, sequence),
            SimWrapper(Vector2(MOLECULE_X, DNA_Y), 0f, dna),
        )
