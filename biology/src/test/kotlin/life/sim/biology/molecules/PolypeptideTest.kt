...
class PolypeptideTest {
    ...
    fun `parse rejects invalid amino acids`() {
        ...
        assertEquals(
            "Invalid amino-acid 'Z' at index 2. Expected one of A, R, N, D, C, E, Q, G, H, I, L, K, M, F, P, S, T, W, Y, V.",
            exception.message,
        )
    }
    ...
    fun `parse rejects trailing whitespace instead of trimming`() {
        ...
        assertEquals(
            "Invalid amino-acid ' ' at index 3. Expected one of A, R, N, D, C, E, Q, G, H, I, L, K, M, F, P, S, T, W, Y, V.",
            exception.message,
        )
    }
}
